...
import WhatsappEditor from "@/app/components/whatsappEditor";
import Emoti from "@/app/components/whatsappEditor/svgs/emoti.svg";
...
const Index = ({value, onChange, title, max}: Props) => {
